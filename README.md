...
3. Restore the primary from a replica and, once complete, resume replication witand up replication in less than a minute and reasonably rely on replication working properly with minimal effort, 
